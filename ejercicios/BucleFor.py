...
La idea detrás de esto es que agregar la palabra Mississippi a un número al contar los segundos en voz 
alta hace que suene más cercano al reloj, y por lo tanto "un Mississippi, dos Mississippi, tres Mississippi" 
...
#misisipi = 1
'''
for i in range(5): # se puede hacer el ciclo for de las dos formas
    print(misisipi, "Mississippi")
    misisipi += 1
    time.sleep(1)
'''    
for misisipi in range(1,6):
    print(misisipi, "Mississippi")
    time.sleep(1)    
